...
def getconnect():
    return p.connect(host="localhost", user="root", password="", database="company")


def insertdata(t):
    db=getconnect()
    cr=db.cursor()
    sql="insert into impinfo values(%s,%s,%s,%s,%s)"
    cr.execute(sql,t)
...
def updatedata(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Name=%s, Department=%s, Salary=%s, Location=%s where Id=%s"
    cr.execute(sql,t)
...
def updateNameByID(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Name=%s where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def updateDeptByID(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Department=%s where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def updateSalByID(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Salary=%s where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def updateLocByID(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Location=%s where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleterow(t):
    db=getconnect()
    cr=db.cursor()
    sql="delete from impinfo where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteName(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Name=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteDept(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Department=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteSal(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Salary=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteLoc(t):
    db=getconnect()
    cr=db.cursor()
    sql="update impinfo set Location=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def fetchName(t):
    db=getconnect()
    cr=db.cursor()
    sql ="select Name from impinfo where ID=%s"
    cr.execute(sql)
    data=cr.fetchall()
    for d in data:
        print (f"{d[1]:^3}")
...
def fetchDept(t):
    db=getconnect()
    cr=db.cursor()
    sql ="select Department from impinfo where ID=%s"
    cr.execute(sql)
    data=cr.fetchall()
    for d in data:
        print (f"{d[2]:^20}")
...
def fetchSal(t):
    db=getconnect()
    cr=db.cursor()
    sql ="select Salary from impinfo where ID=%s"
    cr.execute(sql)
    data=cr.fetchall()
    for d in data:
        print (f"{d[3]:^20}")
...
def fetchLoc(t):
    db=getconnect()
    cr=db.cursor()
    sql ="select Location from impinfo where ID=%s"
    cr.execute(sql)
    data=cr.fetchall()
    for d in data:
        print (f"{d[4]:^20}")
